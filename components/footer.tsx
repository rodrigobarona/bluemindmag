      ...
      <section className="relative py-24 md:py-32 lg:py-40 overflow-hidden">
        ...
        {newsletterImage && (
          <figure className="absolute inset-0">
            <Image
              ...
              loading="lazy"
              placeholder={
                newsletterImage.blurDataURL || newsletterImage.avgColor
                  ? "blur"
                  : "empty"
              }
              blurDataURL={
                newsletterImage.blurDataURL ||
                (newsletterImage.avgColor
                  ? generateBlurPlaceholder(newsletterImage.avgColor)
                  : undefined)
              }
        ...
        <div className="container-narrow relative z-10">
          <motion.div
            ...
            initial={{
              opacity: 0,
              y: prefersReducedMotion ? 0 : ANIMATION_CONFIG.distance.base,
            }}
          ...
          >
            ...
            <h2
              className={`font-headline text-4xl md:text-5xl lg:text-6xl mb-6 text-balance ${
                newsletterImage ? "text-white" : "text-background"
              }`}
            >
